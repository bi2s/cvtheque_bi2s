...
import { Box, Typography, Table, TableHead, TableBody, TableRow, TableCell, Chip, Button, TextField, Stack, CircularProgress } from '@mui/material';
    ...
    <Box sx={{ p: 3, maxWidth: 900 }}>
      ...
      {proposals.length === 0 ? (
        ...
        <Table size="small">
          ...
          <TableBody>
            {proposals.map((p) => (
              <TableRow key={p.id} hover sx={{ cursor: 'pointer' }} onClick={() => navigate(`/rfp/${p.id}`)}>
